...
class Txt2ImgParams(BaseModel):
    ...
    disability : Optional[str] = Field(None, title="Type of disability of the user", description="In case the user has a disability, the user should enter the disabilty", examples=["Blindness", "Deaf"])
